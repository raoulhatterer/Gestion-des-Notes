...
def connexion(event=None):
    ...
    elif role == 'role_professeur':
        messagebox.showwarning("Connexion refusée", "Cette application est réservée à l'administration.\n\nVeuillez utiliser l'application: clientprofesseur.py")
...
root = tk.Tk()
root.title("Gestion des notes (R. Hatterer) CLIENT GESTIONNAIRE")
